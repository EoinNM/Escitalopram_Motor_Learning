    ...
    for subject in population:
        for trial_type in trial_types:
            for con in conditions:
                ...
                ons_path = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject, 'foll')
                ons = os.path.join(ons_path, 'foll_%s.ons'%(con))
                dur_path = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject, 'foll')
                dur = os.path.join(dur_path, 'foll_%s.dur'%(con))

                #create new dirst for each of first, second and last trials
                new_loc = mkdir_path(os.path.join('/NOBACKUP2/molloy/', 'TRIAL_ONS_DURS', '%s'%(trial_type), subject, 'foll'))
...
#                ACC_LRN_path  = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject, 'foll')
#                ACC_LRN       = os.path.join(ACC_LRN_path, '%s_foll.txt'%(subject))
#                ACC_SMP_path  = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject)
#                ACC_SMP       = os.path.join(ACC_SMP_path, '%s_foll_smp.txt'%(subject))
#                #2. RT Scores
#                RT_LRN_path   = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject)
#                RT_LRN        = os.path.join(RT_LRN_path, '%s_foll_RT_lrn.txt'%(subject))
#                RT_SMP_path   = os.path.join('/NOBACKUP2/molloy/MOTORTASK/', subject)
#                RT_SMP        = os.path.join(RT_SMP_path, '%s_foll_RT_SMP.txt'%(subject))
#                
...
copy_files(population)

def update_files(population):
...
#1 Onsets & Durations
    ...
    for subject in population:
        ...
        lrn_ons_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_learn.ons'%('foll'))
        lrn_dur_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_learn.dur'%('foll'))
        smp_ons_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_simple.ons'%('foll'))
        smp_dur_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_simple.dur'%('foll'))
        
        print 'Updating files now for the first trials - %s. %s, %s'%(count, subject, 'foll')
        ...
        lrn_ons_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_learn.ons'%('foll'))
        lrn_dur_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_learn.dur'%('foll'))
        smp_ons_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_simple.ons'%('foll'))
        smp_dur_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_simple.dur'%('foll'))

        print 'Updating files now for the second trials - %s. %s, %s'%(count, subject, 'foll')
        #Create onsets/durs for the first trials in each block
        #1 Onsets
        #A LRN Condition
       ...
       #########################################################################################################
        ...
        lrn_ons_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_learn.ons'%('foll'))
        lrn_dur_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_learn.dur'%('foll'))
        smp_ons_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_simple.ons'%('foll'))
        smp_dur_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_simple.dur'%('foll'))

        print 'Updating files now for the third trials - %s. %s, %s'%(count, subject, 'foll')
...
#        ACC_LRN_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_%s.txt'%(subject, 'foll'))
#        ACC_SMP_1 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_%s_smp.txt'%(subject, 'foll'))
#        RT_LRN_1  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_%s_RT_lrn.txt'%(subject, 'foll'))
#        RT_SMP_1  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/first/', subject, 'foll', '%s_%s_RT_SMP.txt'%(subject, 'foll'))
#        
#        print 'Updating files now for the first trial error & RT Scores - %s. %s, %s'%(count, subject, 'foll')
#        #A Error LRN
...
#        ACC_LRN_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_%s.txt'%(subject, 'foll'))
#        ACC_SMP_2 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_%s_smp.txt'%(subject, 'foll'))
#        RT_LRN_2  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_%s_RT_lrn.txt'%(subject, 'foll'))
#        RT_SMP_2  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/second/', subject, 'foll', '%s_%s_RT_SMP.txt'%(subject, 'foll'))
#        
#        print 'Updating files now for the second trial error & RT Scores - %s. %s, %s'%(count, subject, 'foll')
#        #A Error LRN
...
#        ACC_LRN_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_%s.txt'%(subject, 'foll'))
#        ACC_SMP_3 = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_%s_smp.txt'%(subject, 'foll'))
#        RT_LRN_3  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_%s_RT_lrn.txt'%(subject, 'foll'))
#        RT_SMP_3  = os.path.join('/NOBACKUP2/molloy/TRIAL_ONS_DURS/third/', subject, 'foll', '%s_%s_RT_SMP.txt'%(subject, 'foll'))
#        
#        print 'Updating files now for the third trial error & RT Scores - %s. %s, %s'%(count, subject, 'foll')
#        #A Error LRN
